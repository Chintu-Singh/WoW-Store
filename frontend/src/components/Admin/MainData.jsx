  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6">
        <div className="flex flex-col bg-black text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
        ...
        <div className="flex flex-col bg-primary-blue text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 min-w-full">
        <div className="bg-pink-100 rounded-xl h-auto w-full shadow-lg p-2">
          <Line data={lineState} />
        </div>

        <div className="bg-yellow-100 text-black rounded-xl shadow-lg p-4 text-center">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 min-w-full mb-6">
        <div className="bg-yellow-100 rounded-xl h-auto w-full shadow-lg p-2">
          <Bar data={barState} />
        </div>

        <div className="bg-pink-100 rounded-xl shadow-lg p-4 text-center">
