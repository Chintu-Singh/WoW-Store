    ...
    <>
      ...
      >
        <div className="flex flex-col gap-3 m-2 sm:w-1/2">
          ...
          />
          <TextField
            label="Specifications / Info about the product"
            multiline
            rows={3}
            required
            variant="outlined"
          ...
          <div className="flex justify-between gap-4 items-start">
            ...
            <label className="rounded font-medium bg-black text-center cursor-pointer text-white py-2 px-2.5 shadow hover:shadow-lg">
              <input
                type="file"
                name="logo"
                accept="image/*"
        ...
        <div className="flex flex-col gap-2 m-2 sm:w-1/2">
          <h2 className="font-medium">Descriptions / Info</h2>
