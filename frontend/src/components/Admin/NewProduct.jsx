    ...
    <>
      ...
      >
        <div className="flex flex-col gap-3 m-2 sm:w-1/2">
          ...
          />
          <TextField
            label="Specification / Info about the product"
            multiline
            rows={3}
            required
            variant="outlined"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center border rounded">
              ...
              <span
                ...
                className="py-2 px-6 bg-black text-white rounded-r hover:shadow-lg cursor-pointer"
              >
                Add
              </span>
            </div>
          ...
          <h2 className="font-medium">Seller Details</h2>
          <div className="flex justify-between gap-4 items-start">
            ...
            <label className="rounded bg-black text-center cursor-pointer text-white py-2 px-2.5 shadow hover:shadow-lg">
              <input
                type="file"
                name="logo"
                accept="image/*"
        ...
        <div className="flex flex-col gap-2 m-2 sm:w-1/2">
          <h2 className="font-medium">Descriptions / Other specs</h2>
          ...
          <div className="flex justify-evenly gap-2 items-center">
            ...
            <span
              onClick={() => addSpecs()}
              className="py-2 px-6 bg-black text-white rounded hover:shadow-lg cursor-pointer"
            >
              Attach
            </span>
          </div>
          ...
          <label className="rounded font-medium bg-black text-center cursor-pointer text-white p-2 shadow hover:shadow-lg my-2">
            <input
              type="file"
              name="images"
              accept="image/*"
          ...
          <div className="flex justify-end">
            <input
              form="mainform"
              type="submit"
              className="bg-black uppercase w-1/3 p-3 text-white font-medium rounded shadow hover:shadow-lg cursor-pointer"
              value="Submit"
            />
          </div>
        </div>
