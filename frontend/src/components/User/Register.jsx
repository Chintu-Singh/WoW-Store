            ...
            >
              <div className="flex flex-col gap-4 items-start">
                ...
                <div className="flex flex-col w-full justify-between sm:flex-row gap-3 items-center">
                  ...
                  />
                  <label className="rounded font-medium bg-primary-green text-center cursor-pointer text-white w-full py-2 px-2.5 shadow hover:shadow-lg">
                    <input
                      type="file"
                      name="avatar"
                      accept="image/*"
                ...
                <Link
                  to="/login"
                  className="hover:bg-gray-50 text-primary-blue text-center  py-3 w-full rounded-sm font-medium"
                >
